/**
 * 04 - Navigation & Wayfinding with Ubudu RTLS SDK (JavaScript)
 *
...
console.log('Ubudu RTLS SDK - Navigation Example (JavaScript)\n');
console.log('=================================================\n');
...
async function navigationConcept() {
...
async function extractUtilitiesDemo() {
  if (!venueId) return;
